    ...
    for line in stdin.lock().lines() {
        ...
        match parts[0] {
            "uci" => {
                ...
                println!("option name Stochastic type check default false");
            ...
            "setoption" => {
                if line.contains("name Stochastic") {
                ...
                } else if line.contains("name Hash") {
            ...
            "go" => {
                ...
                let (best_move, _) = pick_move_timed(&board, depth, time_limit, stochastic_mode, &mut state);
